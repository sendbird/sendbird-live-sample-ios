...
//        SBUAlertView.show(
//            title: SBUStringSet.Live.Common.cameraPermissionDeniedAlertTitle,
//            message: SBUStringSet.Live.Common.cameraPermissionDeniedAlertDescription,
//            oneTimetheme: SBUTheme.componentTheme,
//            confirmButtonItem: settingButton,
//            cancelButtonItem: cancelButton,
...
//        )
    ...
    open func showMicAccessPermissionAlert(completionHandler: (() -> Void)? = nil) {
        ...
        SBUAlertView.show(
            title: "SBUStringSet.Live.Common.micPermissionDeniedAlertTitle",
            message: "SBUStringSet.Live.Common.micPermissionDeniedAlertDescription",
            oneTimetheme: SBUTheme.componentTheme,
            confirmButtonItem: settingButton,
            cancelButtonItem: cancelButton,
            dismissHandler: completionHandler
